...
<section class="featured">
    <div class="container">
        <h2 class="title t-3">Produse esențiale</h2>
...
<section class="recomandate">
    <div class="container">
        <h2 class="title t-3">Produse recomandate</h2>

        <div class="recomandate-gallery">
        ...
        <?php
            ...
            foreach($featured_products as $product) {
                ...
                // echo $product->get_title() . ' ' . $product->get_price().'<br>';
                // print("<pre>");
                // print_r($product);
                // print("</pre>");
                    ...
                    <div class="product-item product-sm">
                        ...
                        <div class="bottom-section">
                            ...
                            <div class="add-to-cart">
                                <a href="<?php echo get_permalink( $product->id ) ?>" class="btn light-blue">Vezi detalii</a>
                            </div>
                        </div>
                    </div>
                <?php
