             ...
             <div class="header-right">
                ...
                <p class="btn dark-blue cart" >
                    ...
                    <?php
                        ...
                        if ( $cart_number != 0 ) {
                            echo "<span class='cart-items-number'>" . $cart_number . "</span>";
                        }
                    ?>
                </p>
                <div class="dropdown-cos">
                    <div class="table">
                        ...
                        <div class="total-div">
                            ...
                            <a href="<?php echo $cart_url ?>" class="btn dark-blue cart">Vezi coșul</a>
                        </div>
                        <?php else: ?>
                            <div class="no-items">
                                <p>Niciun produs nu a fost adăugat în coș</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
